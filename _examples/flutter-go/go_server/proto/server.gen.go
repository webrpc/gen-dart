// flutter-go v1.0.0 2197b47f3845279200f3c7c58dc469605b6f3f68
// --
// Code generated by webrpc-gen@v0.37.0 with golang generator. DO NOT EDIT.
//
// webrpc-gen -schema=./service.ridl -target=golang -server -out=go_server/proto/server.gen.go
package proto
...
func WebRPCSchemaHash() string {
	return "2197b47f3845279200f3c7c58dc469605b6f3f68"
}
...
var ItemTier_name = map[ItemTier]string{
	ItemTier_REGULAR: "REGULAR",
	ItemTier_PREMIUM: "PREMIUM",
}

var ItemTier_value = map[string]ItemTier{
	"REGULAR": ItemTier_REGULAR,
	"PREMIUM": ItemTier_PREMIUM,
}

func (x ItemTier) String() string {
	return ItemTier_name[x]
}

func (x ItemTier) MarshalText() ([]byte, error) {
	return []byte(ItemTier_name[x]), nil
}
...
const WebrpcHeaderValue = "webrpc@v0.37.0;gen-golang@v0.27.0;flutter-go@v1.0.0"
